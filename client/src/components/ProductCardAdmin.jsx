    ...
    <div className='w-36 p-4 bg-white rounded'>
      ...
      <div className='grid grid-cols-2 gap-2 py-2'>
        ...
        <button
          ...
          className='flex items-center justify-center border px-3 py-2 text-base border-green-600 bg-green-600 text-white hover:bg-green-700 rounded'
        >
          Edit
        </button>
        ...
        <button
          ...
          className='flex items-center justify-center border px-3 py-2 text-base  border-red-600 bg-red-600 text-white hover:bg-red-700 rounded'
        >
          Delete
        </button>
