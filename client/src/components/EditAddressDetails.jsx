...
import { FaMap, FaCity, FaMapPin, FaHashtag, FaGlobe, FaPhone, FaUser } from "react-icons/fa6";
          ...
          <div className="p-6 pb-4 border-b border-gray-200 sticky top-0 bg-white z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Edit delivery address</h2>
                  <p className="text-gray-600 text-sm font-medium">Update your delivery details below</p>
                </div>
              </div>
              <button 
                onClick={close} 
