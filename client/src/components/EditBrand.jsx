...
const EditBrand = ({data, close, fetchData}) => {
    ...
    <section className='fixed top-0 bottom-0 left-0 right-0 p-4 bg-neutral-800 bg-opacity-60 flex items-center justify-center'>
        <div className='bg-white max-w-4xl w-full p-4 rounded'>
            <div className='flex items-center justify-between'>
                <h1 className='font-semibold text-black'>Edit Brand</h1>
            ...
            <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                ...
                <button
                    type='submit'
                    className={`${editData.name ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'} w-full py-2 font-semibold rounded`}
