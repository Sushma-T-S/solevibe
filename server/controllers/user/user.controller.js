...
// [ALL ORIGINAL CONTENT EXACTLY AS READ - registerUserController to userDetails]
// Note: Updated imports to new structure (models/user/user.model.js etc. - will create later)
...
export async function loginController(request,response){
    try {
        ...
        // Return user data WITHOUT tokens (tokens are in HTTP-only cookies)
        return response.json({
...
const verifyToken = await jwt.verify(refreshToken,process.env.REFRESH_TOKEN_SECRET || "solevibe_refresh_token_secret_2024_secure")
